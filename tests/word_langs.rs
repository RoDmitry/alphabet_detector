...
#[rstest(expected_language, word, expected_languages,
    ...
    case(Catalan, "substituïts", ahashset!(Afrikaans, AymaraCentral, Catalan, Dutch, French, Portuguese, Welsh)),
    ...
    case(French, "façonnage", ahashset!(AlbanianTosk, AzerbaijaniNorth, Basque, Bokmal, Catalan, French, Friulian, Kabuverdianu, KurdishNorthern, Ligurian, Occitan, Portuguese, TatarCrimean, Turkish, Turkmen, Venetian)),
    case(French, "forêt", ahashset!(Afrikaans, French, Friulian, Kabuverdianu, KurdishNorthern, Portuguese, Sepedi, Welsh)),
    case(French, "où", ahashset!(Czech, Fon, French, Friulian, GaelicScottish, Italian, Limburgish, Lombard, Portuguese, Sardinian, Sicilian, Venetian, Vietnamese, Welsh, Yoruba)),
    case(French, "succèdent", ahashset!(Acehnese, Afrikaans, Catalan, CreoleHaitian, Czech, Dutch, Fon, French, Friulian, GaelicScottish, Italian, Limburgish, Lombard, Occitan, Papiamento, Portuguese, Sardinian, Sesotho, Sicilian, Venetian, Vietnamese, Welsh)),
    ...
    case(Italian, "venerdì", ahashset!(Czech, Fon, Friulian, Italian, Limburgish, Lombard, Portuguese, Sardinian, Sicilian, Venetian, Vietnamese)),
